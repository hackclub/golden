  ...
  return (
   ...
   <a href="https://airtable.com/appucgN7GgruOVlmn/shrumqEWK3tOLXYVP" class="flex justify-center">
    <button class="bg-red-500 hover:bg-red-700 text-white font-bold text-xl py-2 px-4 rounded">
      ...
      <div class="flex flex-col sm:flex-row sm:flex-wrap justify-center items-center gap-5 p-4">
        <img class="rounded-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/6 object-cover h-40 sm:h-48 md:h-52 lg:h-60" src="https://cloud-cci0049xc-hack-club-bot.vercel.app/00.jpg" alt="Image at Assemble" />
        <img class="rounded-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/6 object-cover h-40 sm:h-48 md:h-52 lg:h-60" src="https://cloud-cci0049xc-hack-club-bot.vercel.app/1alpine.jpeg" alt="Image at Alpine Hackathon Workshop" />
        <img class="rounded-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/6 object-cover h-40 sm:h-48 md:h-52 lg:h-60" src="https://cloud-cci0049xc-hack-club-bot.vercel.app/5horizon.png" alt="Image at Horizon Hackathon" />
        <img class="rounded-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/6 object-cover h-40 sm:h-48 md:h-52 lg:h-60" src="https://cloud-cci0049xc-hack-club-bot.vercel.app/2epoch.jpg" alt="Image 3" />
        <img class="rounded-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/6 object-cover h-40 sm:h-48 md:h-52 lg:h-60" src="https://cloud-cci0049xc-hack-club-bot.vercel.app/6spark.jpg" alt="Image 5" />
      </div>
